...
void HelloTriangleApp::createVertexBuffer() {
	...
	// memory property: able to map it so we can write to it from the CPU
	...
	// VK_MEMORY_PROPERTY_HOST_COHERENT_BIT ensures that
	// the mapped memory always matches the contents of the allocated memory
