...
void HelloTriangleApp::createTextureImage() {
	...
	stbi_uc* pixels = stbi_load("resource/texture/texture.jpg",
...
void HelloTriangleApp::createImageView(VkImage image, VkFormat format, vklab::VkDeleter<VkImageView>& imageView) {
